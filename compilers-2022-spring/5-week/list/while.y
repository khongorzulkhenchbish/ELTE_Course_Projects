...
|
    ...
    {
        std::cout << "declaration -> T_INTEGER T_LIST T_ID T_SEMICOLON" << std::endl;
    }
|
    T_BOOLEAN T_LIST T_ID T_SEMICOLON
    {
        std::cout << "declaration -> T_BOOLEAN T_LIST T_ID T_SEMICOLON" << std::endl;
    }
...
|
    ...
    {
        std::cout << "assignment -> T_ID T_APPEND list_literal T_SEMICOLON" << std::endl;
    }
|
    T_ID T_SOPEN T_NUM T_SCLOSE T_ASSIGN expression T_SEMICOLON
    {
        std::cout << "assignment -> T_ID T_SOPEN T_NUM T_SCLOSE T_ASSIGN expression T_SEMICOLON" << std::endl;
    }
...
|
    multi_list_values
    {
        std::cout << "list_values -> multi_list_values" << std::endl;
    }
;
...
|
    ...
    {
        std::cout << "multi_list_values -> expression T_COMMA multi_list_values" << std::endl;
    }
;
    /* ----- Solution END ----- */
...
|
    ...
    {
        std::cout << "read -> T_READ T_OPEN T_ID T_SOPEN T_NUM T_SCLOSE T_CLOSE T_SEMICOLON" << std::endl;
    }
...
|
    ...
    {
        std::cout << "assignment -> T_ID T_SOPEN T_NUM T_SCLOSE" << std::endl;
    }
|
    expression T_CONCAT expression
    {
        std::cout << "assignment -> expression T_CONCAT expression" << std::endl;
    }
