...
%token T_COLON
    ...
    /*
    * The reason these are treated as normal tokens
    * instead of an operator is because we are making
    * a simple version of the ternary operator.
    */
...
|
    ...
    {
        std::cout << "expression -> T_OPEN expression T_QUESTIONMARK expression T_COLON expression T_CLOSE" << std::endl;
    }
