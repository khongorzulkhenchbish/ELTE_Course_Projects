...
|
    T_SOPEN statement_no_semicolon T_PARALLEL statement_no_semicolon T_SCLOSE T_SEMICOLON
    {
        std::cout << "statement -> T_SOPEN statement_no_semicolon T_PARALLEL statement_no_semicolon T_SCLOSE T_SEMICOLON" << std::endl;
    }

    /*
    * Follows the logic of an operator rule for expressions.
    */
...
statement_no_semicolon:
    T_SKIP
    {
        std::cout << "statement_no_semicolon -> T_SKIP" << std::endl;
    }
|
...
|
    T_SOPEN statement_no_semicolon T_PARALLEL statement_no_semicolon T_SCLOSE
    {
        std::cout << "statement_no_semicolon -> T_SOPEN statement_no_semicolon T_PARALLEL statement_no_semicolon T_SCLOSE" << std::endl;
    }
;
