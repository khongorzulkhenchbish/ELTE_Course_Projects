...
declaration:
    T_INTEGER T_ID T_SEMICOLON
    {
        ...
        symbol_table[*$2] = var_data( d_loc__.first_line, integer, new_label(), false, false );
...
|
    T_BOOLEAN T_ID T_SEMICOLON
    {
        ...
        symbol_table[*$2] = var_data( d_loc__.first_line, boolean, new_label(), false, false );
...
|
    T_CONST T_INTEGER T_ID T_SEMICOLON
    {
        ...
        symbol_table[*$3] = var_data( d_loc__.first_line, integer, new_label(), true, false );
...
|
    T_CONST T_BOOLEAN T_ID T_SEMICOLON
    {
        ...
        symbol_table[*$3] = var_data( d_loc__.first_line, boolean, new_label(), true, false );
...
assignment:
    T_ID T_ASSIGN expression T_SEMICOLON
    {
        ...
        if( symbol_table[*$1].is_const && symbol_table[*$1].value_assigned)
        {
            std::stringstream ss;
            ss << "Re-assignment to const variable: " << *$1 << std::endl;
            error( ss.str().c_str() );
        }
        ...
        symbol_table[*$1].value_assigned = true;
...
read:
    T_READ T_OPEN T_ID T_CLOSE T_SEMICOLON
    {
        ...
        if( symbol_table[*$3].is_const && symbol_table[*$3].value_assigned)
        {
            std::stringstream ss;
            ss << "Re-assignment to const variable: " << *$3 << std::endl;
            error( ss.str().c_str() );
        }
        ...
        symbol_table[*$3].value_assigned = true;
