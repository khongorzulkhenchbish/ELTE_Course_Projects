...
%type <code> declaration declarations statement statements assignment read write branch loop

    /*
    * Added code attributes to declaration declarations
    */
