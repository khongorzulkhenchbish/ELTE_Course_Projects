...
%%
    ...
    /* 
    * T_THEN, T_DO were swapped with T_BEGIN
    * T_ENDIF, T_DONE were swapped with T_END
    * Added T_END before T_ELSE and T_BEGIN after it in the if statement.
    * The unnecessary terminals were removed.
    */
