...
|
    inc_and_dec T_SEMICOLON
    {
        std::cout << "statement -> inc_and_dec T_SEMICOLON" << std::endl;
    }
...
|
    inc_and_dec
    {
        std::cout << "expression -> inc_and_dec" << std::endl;
    }
...
inc_and_dec:
    T_ID T_INC
    {
        std::cout << "inc_and_dec -> T_ID T_INC" << std::endl;
    }
|
    T_INC T_ID
    {
        std::cout << "inc_and_dec -> T_INC T_ID" << std::endl;
    }
|
    T_ID T_DEC
    {
        std::cout << "inc_and_dec -> T_ID T_DEC" << std::endl;
    }
|
    T_DEC T_ID
    {
        std::cout << "inc_and_dec -> T_DEC T_ID" << std::endl;
    }
;
