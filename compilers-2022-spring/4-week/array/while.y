...
|
    T_ID T_SOPEN T_SCLOSE T_ASSIGN T_COPEN array_values T_CCLOSE T_SEMICOLON
    {
        std::cout << "assignment -> T_ID T_SOPEN T_SCLOSE T_ASSIGN T_COPEN array_values T_CCLOSE T_SEMICOLON" << std::endl;
    }
|
    T_ID T_SOPEN expression T_SCLOSE T_ASSIGN expression T_SEMICOLON
    {
        std::cout << "assignment -> T_ID T_SOPEN expression T_SCLOSE T_ASSIGN expression T_SEMICOLON" << std::endl;
    }
...
array_values:
    //empty
    {
        std::cout << "array_values -> epsilon" << std::endl;
    }
|
    expression
    {
        std::cout << "array_values -> expression" << std::endl;
    }
|
    expression T_COMMA array_values
    {
        std::cout << "array_values -> expression T_COMMA array_values" << std::endl;
    }
;
...
|
    ...
    {
        std::cout << "read -> T_READ T_OPEN T_ID T_SOPEN expression T_SCLOSE T_CLOSE T_SEMICOLON" << std::endl;
    }
...
|
    ...
    {
        std::cout << "expression -> T_ID T_SOPEN expression T_SCLOSE" << std::endl;
    }
